      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex flex-col lg:grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <motion.button
              className="border-2 border-stone-300 text-stone-700 px-8 py-4 rounded-full hover:border-amber-700 hover:text-amber-700 transition-all duration-300 font-medium flex items-center justify-center gap-2"
