    ...
    <section id="contact" ref={ref} className="py-20 md:py-14 lg:py-20 bg-gradient-to-tr from-white via-gray-50 to-amber-50">
      <div className="w-full px-4 md:px-6 lg:px-8">
        <motion.div
          ...
          className="text-center mb-16 md:mb-10 lg:mb-16"
        >
          <span className="inline-block px-4 py-2 md:px-3 md:py-1.5 lg:px-4 lg:py-2 bg-gradient-to-r from-amber-100 to-orange-100 rounded-full text-amber-800 font-medium text-sm md:text-xs lg:text-sm mb-4 md:mb-3 lg:mb-4 shadow-sm border border-amber-200/50">
            Contáctanos
          </span>
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6 md:space-y-4 lg:space-y-6">
              <div className="flex items-start space-x-4 md:space-x-3 lg:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm md:text-xs lg:text-sm">123 Innovation Drive, Tech District</p>
                  <p className="text-gray-700 text-sm md:text-xs lg:text-sm">San Francisco, CA 94105</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4 md:space-x-3 lg:space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm md:text-xs lg:text-sm">+1 (555) 123-ROAST</p>
                  <p className="text-gray-700 text-sm md:text-xs lg:text-sm">hello@roastcraft.com</p>
                </div>
              </div>
          ...
          >
            ...
            <form className="space-y-5 md:space-y-3 lg:space-y-5">
